...
public class ModelSkylineNear extends Object2D {
	...
	public void calculateThis(long timeDiff) {
		...
		if (firstX >= 0) {
			...
			newSkyline.setDepthRecursive(depth() - 3000);
	...
	private void show() {
		if (_show)
			return;
		_show = true;
		Object2D rect = new ModelRect(800, 50, 0, 340, 0xffb0b0ff);
		rect.setDepth(depth() - 3000);
		...
		for (int x = -210; x < 1010; x += 210) {
			...
			skyline.setX(x);
			skyline.setY(340);
			skyline.setDepthRecursive(depth() - 3000);
